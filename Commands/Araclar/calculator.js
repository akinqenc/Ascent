    ...
    async execute(interaction)
    {
        ...
        collector.on('collect', async i =>
        {
            ...
            if(value === "=")
            {
                ...
                {
                    data = "";
                    extra = "Bir sorun oluştu, lütfen C butonuna basarak değerleri yeniden giriniz."
                }
            }
            else if(value === "clear")
            {
                data = "";
                extra = "Sonuçlar burada gösterilecek"
            }
